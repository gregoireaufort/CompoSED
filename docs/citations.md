...
CompoSED is a thin inference and interface layer around scientific modeling
codes. If a paper, talk, or data release uses one of these backends, cite the
underlying model code as well as CompoSED.
...
> samplers with CIGALE and FSPS/python-fsps. We thank the developers of these
> public scientific modeling codes and cite the corresponding model papers
> where those components were used.
